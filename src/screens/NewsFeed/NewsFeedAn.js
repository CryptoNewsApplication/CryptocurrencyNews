...
class NewsFeedAn extends Component {
    ...
    itemSelectedHandler = key => {
        const selNews = this.props.analysisNews.find(oneNews =>{
...
const mapStateToProps = state => {
    return {
        analysisNews: state.news.analysisNews,
...
export default connect(mapStateToProps, mapDispatchToProps)(NewsFeedAn);