...
class NewsFeedEx extends Component {
    ...
    itemSelectedHandler = key => {
        const selNews = this.props.exchangesNews.find(oneNews =>{
...
const mapStateToProps = state => {
    return {
        exchangesNews: state.news.exchangesNews,
...
export default connect(mapStateToProps, mapDispatchToProps)(NewsFeedEx);