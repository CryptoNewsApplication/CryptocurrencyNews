...
class NewsFeedBl extends Component {
    ...
    itemSelectedHandler = key => {
        const selNews = this.props.blockchainNews.find(oneNews =>{
    ...
    render () {
        let content = (
            <View>
                <NewsList 
                    news={this.props.blockchainNews} 
...
const mapStateToProps = state => {
    return {
        blockchainNews: state.news.blockchainNews,
...
export default connect(mapStateToProps, mapDispatchToProps)(NewsFeedBl);